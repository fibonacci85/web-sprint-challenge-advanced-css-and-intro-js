...
//   removeArtist (artists, 0)
  ...
  function removeArtist(array, index){
    const anotherArray = []
    array.slice(anotherArray[index]);
...
console.log (addArtist(artists, 20, 'Francis Bonacic', '1985 - 2020', "Surrealism",'Chilean', "He's a smalltown boy living in a lonely world, took the midnight train going anywhere. Bown and raised in South Detroit"))
